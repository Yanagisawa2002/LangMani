...
def test_phase2b2_contract_uses_independent_identity_and_exact_features() -> None:
    ...
    assert config.payload["expert_id"] == "PushToRegionExpert/CandidateM"
    assert config.payload["accepted_expert_commit"] == ("1210976e0b926f913504cc8875dc6033d1926224")
...
def test_atomic_shard_resume_reuses_verified_episode_and_rejects_tampering(
    ...
    resumed = push_collection._collect_shard_atomic(
        ...
        resume=True,
        expert_identity="PushToRegionExpert/CandidateM@1210976",
    )
