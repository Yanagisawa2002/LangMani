...
# Execute the sampled trajectory once; extra holds consume the fixed 200-step
# horizon without resolving the native Panda's observed tracking residual.
FINAL_WAYPOINT_REFINEMENT_STEPS = 0
TCP_POSITION_TOLERANCE = 0.015
