...
the isolated G--O diagnostic candidates qualified for a fresh formal gate. Candidate O also stopped
on a zero-tolerance cylinder workspace exit after four cube successes. No v2 episode or frame was
collected, no archive or dataset package was accepted, and no SmolVLA optimizer step ran. See the
